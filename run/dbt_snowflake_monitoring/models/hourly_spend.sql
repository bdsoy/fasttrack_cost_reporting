        ...
        create or replace transient table fasttrack_cost_reporting_dev.landing_snowflake_monitoring.hourly_spend
         as
        (-- depends_on: fasttrack_cost_reporting_dev.landing_snowflake_monitoring.stg_metering_history
...
filtered as (
    ...
    select *
    from all_periods
    where date_hour <= '2025-03-13 17:00:00+00:00'
