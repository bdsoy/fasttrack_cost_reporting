-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into fasttrack_cost_reporting_dev.landing_snowflake_monitoring.query_direct_object_access as DBT_INTERNAL_DEST
        using fasttrack_cost_reporting_dev.landing_snowflake_monitoring.query_direct_object_access__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
