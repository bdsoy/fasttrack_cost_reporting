  ...
  create or replace   view fasttrack_cost_reporting_dev.landing_snowflake_monitoring.query_direct_table_access
...
(
    ...
    "FULL_TABLE_NAME" COMMENT $$Fully qualified table name, i.e. <database_name>.<schema_name>.<table_name>$$, 
