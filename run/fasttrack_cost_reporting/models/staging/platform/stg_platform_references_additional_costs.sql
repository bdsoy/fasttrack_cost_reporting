        ...
        create or replace transient table fasttrack_cost_reporting_dev.transform_cost_reporting.stg_platform_references_additional_costs
  ...
  (
    ...
    spend number(38,12) not null,
    unique_key number(19,0) not null,
    dbt_loaded_at timestamp_ntz not null
         ...
         as
        (
    select platform, billing_date, account, service_category, service_subcategory, resource, spend, unique_key, dbt_loaded_at
    from (
